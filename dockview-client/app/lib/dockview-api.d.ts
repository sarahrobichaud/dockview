...
export type VaultReaderErrorResult = [null, VaultReaderError];
...
export type VaultReaderResult<T> =
...
export type AllProjects = ExtractVaultReaderResult<
  typeof vaultReader.readAllProjects
>;
export type GetAllProjectsResponse = V1Response<AllProjects>;
export type ProjectVersions = ExtractVaultReaderResult<
